...
enum DancerButton {
    DANCER_TEST = 0, DANCER_SERVICE,
    DANCER_P1_LEFT, DANCER_P1_CENTRE, DANCER_P1_RIGHT,
    DANCER_P2_LEFT, DANCER_P2_CENTRE, DANCER_P2_RIGHT,
    DANCER_P1_L_SENSOR_TOP, DANCER_P1_L_SENSOR_BOT,
    DANCER_P1_R_SENSOR_TOP, DANCER_P1_R_SENSOR_BOT,
    DANCER_P2_L_SENSOR_TOP, DANCER_P2_L_SENSOR_BOT,
    DANCER_P2_R_SENSOR_TOP, DANCER_P2_R_SENSOR_BOT,
};
